  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'gold-lg': '0 20px 40px -15px rgba(212, 175, 55, 0.5)',
      ...
      backgroundImage: {
        ...
        'gradient-gold': 'linear-gradient(135deg, #fbbf24 0%, #d4af37 50%, #b8860b 100%)',
        'gradient-gold-shine': 'linear-gradient(110deg, transparent 25%, rgba(255,255,255,0.3) 50%, transparent 75%)',
